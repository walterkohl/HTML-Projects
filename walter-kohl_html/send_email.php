<?php
//send_email.php
$email_from = "postmaster@walter-kohl.ch";   //Absender falls keiner angegeben wurde
$sendermail_antwort = false;      //E-Mail Adresse des Besuchers als Absender. false= Nein ; true = Ja
$name_von_emailfeld = "info@walter-kohl.ch";   //Feld in der die Absenderadresse steht
 
$empfaenger = "walter.kohl@hotmail.com"; //Empfänger-Adresse
...
$betreff = $_POST['subject']; //Betreff der Email

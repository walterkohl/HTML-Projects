<?php
//send_email.php
$email_from = "postmaster@peter-rudolf-photo-collages.ch";   //Absender falls keiner angegeben wurde
$sendermail_antwort = false;      //E-Mail Adresse des Besuchers als Absender. false= Nein ; true = Ja
$name_von_emailfeld = "info@peter-rudolf-photo-collages.ch";   //Feld in der die Absenderadresse steht
 
$empfaenger = "info@peter-rudolf-photo-collages.ch"; //Empfänger-Adresse
// $empfaenger = "walter.kohl@hotmail.com"; //Empfänger-Adresse beim Testen
$mail_cc = ""; //CC-Adresse, diese E-Mail-Adresse bekommt einer weitere Kopie
$betreff = $HTTP_POST['subject']; //Betreff der Email
 
$url_ok = "success.html"; //Zielseite, wenn E-Mail erfolgreich versendet wurde
$url_fehler = "error.html"; //Zielseite, wenn E-Mail nicht gesendet werden konnte
